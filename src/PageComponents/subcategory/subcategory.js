      ...
      <AquaLayout>
        <div className="row">
          <div className="col-md-4 col-lg-4 col-xs-12 col-sm-12">
            ...
            {!subcategories.length ? <h3>No Sub Categories yet</h3> : (
              <div>
                {subcategories.map((r, i) => (
                  <AquaCategoryCard r={r} key={i} handleEdit={handleEditSubCategory} handleShare={handleShareSubCategory} handleDelete={handleDeleteSubCategory} />
                ))}
              </div>
            )}
          </div>
